...
import ones.quzhigang.supprot.Fild;
...
public class TestVelocity {
	...
	private static final String url = "jdbc:mysql://127.0.0.1:3306/spring4x?useUnicode=true&characterEncoding=utf-8";
	private static final String user = "root";
	private static final String password = "root";

	private static String talbeName="tbl_user";
	...
	private static String  rootPath = "F:\\study_dir\\study_git\\spring4x\\"; // 物理目录
	...
	private static void createModel() throws ResourceNotFoundException, ParseErrorException, Exception{
		...
		Template actionTpt = ve.getTemplate("/src/main/resources/template/model.vm");
		...
		// 生成文件 模板 内容容器 新文件位置
		merge(actionTpt, ctx, rootPath + "/src/main/java/ones/quzhigang/bean/"
	...
	private static void createMapper() throws ResourceNotFoundException, ParseErrorException, Exception{
		...
		Template mapperTmp = ve.getTemplate("/src/main/resources/template/mapper.vm");
		...
		merge(mapperTmp, mapperCtx, rootPath
				+ "src/main/java/ones/quzhigang/mapper/" + classNameUpCase
				+ "Mapper.java");
	...
	private static void createProvider() throws ResourceNotFoundException, ParseErrorException, Exception{
		...
		Template providerTmp = ve.getTemplate("/src/main/resources/template/provider.vm");
		...
		merge(providerTmp, providerCtx, rootPath
				+ "src/main/java/ones/quzhigang/provider/" + classNameUpCase
				+ "Provider.java");
	...
	private static void createQuery() throws ResourceNotFoundException, ParseErrorException, Exception{
		...
		Template queryTmp = ve.getTemplate("/src/main/resources/template/query.vm");
		...
		merge(queryTmp, queryCtx, rootPath
				+ "src/main/java/ones/quzhigang/query/" + classNameUpCase
				+ "Query.java");
	...
	private static void createService() throws ResourceNotFoundException, ParseErrorException, Exception{
		...
		Template serviceTmp = ve.getTemplate("/src/main/resources/template/service.vm");
		...
		merge(serviceTmp, serviceCtx, rootPath
				+ "src/main/java/ones/quzhigang/service/" + classNameUpCase
				+ "Service.java");
	...
	private static void createServiceImpl() throws ResourceNotFoundException, ParseErrorException, Exception{
		...
		Template serviceImplTmp = ve.getTemplate("/src/main/resources/template/serviceImpl.vm");
		...
		merge(serviceImplTmp, serviceImplCtx, rootPath
				+ "src/main/java/ones/quzhigang/service/impl/" + classNameUpCase
				+ "ServiceImpl.java");
	...
	private static void createMybatisXml() throws ResourceNotFoundException, ParseErrorException, Exception{
		...
		Template mybatis_xxxxxTmp = ve.getTemplate("/src/main/resources/template/mybatis_xml.vm");
		...
		merge(mybatis_xxxxxTmp, mybatis_xxxxxCtx, rootPath
				+ "src/main/java/ones/quzhigang/mapping/" + "MYBATIS_"
